        ...
        <>
            {
                ...
                (
                    ...
                    <Container className="mt-5" >
                        <Row>
                            <Col>
                                <div className="product_card p-4 d-flex flex-column gap-3 gap-md-4 rounded-4 shadow mb-5">
                                    <Row id="view-title">
                                        <h2 className="fw-semibold text-center">Product Overview</h2>
                                        ...
                                        <Col lg={6} className="mb-4 d-flex flex-column gap-4">
                                            <div>
                                                ...
                                                <p className="mb-4 primary">
                                                    <FontAwesomeIcon id="star" icon="fa-solid fa-star" />
                                                    <FontAwesomeIcon id="star" icon="fa-solid fa-star" />
                                                    <FontAwesomeIcon id="star" icon="fa-solid fa-star" />
                                                    <FontAwesomeIcon id="star" icon="fa-solid fa-star" />
                                                    <FontAwesomeIcon id="star" icon="fa-solid fa-star-half-stroke" />
                                                </p>
                                                <h3 className="fw-light">&#8369;{price}/{gram}</h3>
                                            </div>

                                            <h6>Product Details:</h6>
                                            <p className="text-secondary">Type: {category}<br />{description}</p>
                                            ...
                                            <div className="row">
                                                <div className="col d-flex gap-3 align-items-center">
                                                    ...
                                                    <span type="button">
                                                        <FontAwesomeIcon id="heart" icon="fa-solid fa-heart" className="fs-3"/>
                                                    </span>
                                                </div>
                                            </div>
                                        </Col>
