    ...
    <Container>
      <Row className="my-5">
        <Col className="p-0  d-flex justify-content-center align-items-center">
          <div id="login-form" className="p-5 d-flex flex-column justify-content-center gap-3">
        ...
        {/* </Col> */}
        {/* <Col className="p-0 d-none d-lg-block h-50"> */}
          <img src={veg} alt="login-img" className="img_box rounded-3 shadow" />
        </Col>
      </Row>
    </Container>
    <FooterSection/>
