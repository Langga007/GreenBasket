...
const ProductSearch = ({ fetchData, productsData }) => {
    ...
    return (
        <>
            <Container>
                <Row className="py-3">
                    <h1 className="d-block fw-medium d-flex align-items-center gap-2">Available Products<span className="fs-2">{`(${productCount})`}</span></h1>
                    <h5 className="d-block fw-medium text-secondary">Nature's Grocery Store at Your Doorstep</h5>
                    <div>
